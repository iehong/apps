...
$lang = [
	...
	'database_connect_error' => '无法连接数据库',
	...
	'tips_ucenter_comment' => 'UCenter 是 Discuz! 团队产品的核心服务程序，Discuz! Board 的安装和运行依赖此程序。如果您已经安装了 UCenter，请填写以下信息。否则，请到 <a href="https://www.discuz.vip/" target="blank">Comsenz 产品中心</a> 下载并且安装，然后再继续。',
	...
	'redisserver_comment' => '如果使用 API 接口，请填写 Redis 服务器地址，格式“127.0.0.1:6379”，否则可留空',
	...
	'install_succeed' => '安装用户中心成功，点击进入管理中心',
...
<p>版权所有 (c) 2001-'.date('Y').'，合肥贰道网络科技有限公司、腾讯科技（北京）有限公司 保留所有权利。</p>

<p>感谢您选择 UCenter 产品。希望我们的努力能为您提供一个高效快速和强大的用户中心解决方案。</p>

<p>合肥贰道网络科技有限公司下文中将简称“贰道网络公司”，腾讯科技（北京）有限公司将简称“腾讯公司”，UCenter 产品将简称“本产品”。</p>

<p>贰道网络公司及腾讯公司拥有本产品的全部知识产权。本产品只供许可协议，并非出售。贰道网络公司只允许您在遵守本协议各项条款的情况下复制、下载、安装、使用或者以其他方式受益于本产品的功能或者知识产权。</p>

<p>本产品著作权已在中华人民共和国国家版权局注册，著作权受到法律和国际公约保护。使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用 UCenter 软件。</p>

<p>本授权协议适用且仅适用于 UCenter 2.x 版本，贰道网络公司拥有对本授权协议的最终解释权。</p>

<h3>I. 协议许可的权利</h3>
<ol>
<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途或商业用途使用（局限于本协议所适配许可的情况下），而不必支付软件版权授权费用。</li>
<li>您可以在协议规定的约束和限制范围内修改本产品源代码(如果被提供的话)或界面风格以适应您的网站要求。</li>
...
<li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用本产品的整体或任何部分，未经书面许可，页面页脚处的 UCenter 名称和下属网站（https://www.discuz.vip） 的链接都必须保留，而不能清除或修改。</li>
...
<li>贰道网络公司不对使用本软件构建的网站中的文章或信息承担责任。</li>
</ol>

<p>有关 UCenter 最终用户授权协议、商业授权与技术服务的详细内容，均由本产品官方网站独家提供。贰道网络公司拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>

<p>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装本产品，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p></div>',
