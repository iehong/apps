    ...
    <div class="moduleElHight">
        ...
        <div class="moduleElTable" :class="{ 'modulElTableGai': tableHig }" style="border: 1px solid #ebeef5; width: calc(100% - 2px);">
            <el-table :data="tableData" style="width: 100%" stripe
                ...
                <el-table-column prop="photo_status" label="状态" width="100">
                    <template slot-scope="scope">
                        <div class="admin_state">
                            <span v-if="scope.row.photo_status == 0" class="admin_state1">已审核</span>
                            <span v-else-if="scope.row.photo_status == 1" class="admin_state4">未审核</span>
                            <span v-else-if="scope.row.photo_status == 2" class="admin_state2">未通过</span>
        ...
        <div class="modluDrawer">
            <el-dialog title="个人头像" :visible.sync="statusVisible" :with-header="true" :modal-append-to-body="false"
        ...
        <!--修改弹出框-->
        <div class="modluDrawer">
            <el-dialog title="修改头像" :visible.sync="editVisible" :with-header="true" :modal-append-to-body="false"
                :show-close="true" width="450px">
                <div class="wxsettip_small ">姓名</div>
                <el-input placeholder="" v-model="info.username_n" :disabled="true"></el-input>
                <div class="wxsettip_small ">头像图片</div>
