...
$languages = [
	...
	'login_getpw' => '找回密码',
	'register_repeat_password' => '重复密码',
	'register_submit' => '注 册',

	'menu_index' => '首页',
	'menu_basic_setting' => '基本设置',
	'menu_field_setting' => '字段管理',
	'menu_restful_setting' => '接口管理',
	...
	'setting_user_length' => '用户名最大长度',
	'setting_user_length_comment' => '修改此项将同时修改 username 字段的长度，最大值 255，只可增加不可减少，请谨慎操作',
	...
	'home_dev_thanks' => '永远鸣谢',
	'home_click_view' => '点击查看',
	...
	'field_new' => '添加新字段',
	'field_name' => '名称',
	'field_name_comment' => '字段的外显名称',
	'field_field' => '字段名',
	'field_field_comment' => '字段的英文名，由英文字母、数字和下划线组成，必须以字母开头',
	'field_index' => '索引',
	'field_index_comment' => '如果字段用于查询条件，请勾选此选项，不建议对字串和长文本使用索引',
	'field_unique' => '不可重复',
	'field_unique_comment' => '如果字段具有唯一特性不可重复，请勾选此选项',
	'field_type' => '类型',
	'field_type_comment' => '字段的类型',
	'field_int' => '整数',
	'field_double' => '浮点数',
	'field_varchar' => '字串',
	'field_text' => '长文本',
	'field_len' => '长度',
	'field_len_comment' => '整数类型的字段请填写 1~10 的数字；浮点数请填写 “m,d” 格式的数字（m 1~10，d 1~5），字串类型请填写 1~255 的数字',
	'field_unsigned' => '无符号',
	'field_unsigned_comment' => '如果数字只有正数无负数，请勾选此选项',

	'restful_ls' => '接口列表',
	'restful_app_ls' => '应用列表',
	'restful_app_new' => '添加新应用',
	'restful_app_name' => '接口应用名称',
	'restful_available' => '可用',
	'restful_api_url' => '接口地址',
	'restful_api_limit' => '调用频率(每分钟) (默认 0 表示不限制)',
	'restful_callback' => '回调域名',
	'restful_callback_comment' => '如果当前应用使用 “/user/authorize” 接口，可填写此选项限制回调地址提高安全性。一行一个域名',
