<template>
    <div class="setUpload">
        <div class="uploadTable">
            ...
            <div class="playbillHeader">
                <div class="playbillHeaText">
                    ...
                    <span>海报大小（1080 * 1920）；二维码区域：高度380，距离左右 350，距离底部 230</span>
                </div>
            </div>
        ...
        <div class="modluDrawer">
            <el-dialog title="公招海报管理" width="500px" :visible.sync="dialogAdd" :modal-append-to-body="false">
...
module.exports = {
    ...
    methods: {
        ...
        getList() {
            let that = this;
            httpPost('m=yunying&c=yingxiao_hbconfig&a=gongzhao').then(function (response) {
        ...
        save() {
            ...
            list.forEach(item => {
                if (item.checked) {
                    params.sy_gongzhao_hb += params.sy_gongzhao_hb ? ',' + item.id : item.id;
                }
            })
