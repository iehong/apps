<template>
    <div class="setUpload">
        <div class="uploadTable">
            ...
            <div class="playbillHeader">
                <div class="playbillHeaText">
                    ...
                    <span>海报大小（1080 * 1920）；二维码区域：高 484 ，距离左右 300，距离头部 650</span>
                </div>
            </div>
        ...
        <div class="modluDrawer">
            <el-dialog title="邀请注册海报管理" width="500px" :visible.sync="dialogAdd" :modal-append-to-body="false">
...
module.exports = {
    ...
    methods: {
        ...
        getList() {
            let that = this;
            httpPost('m=yunying&c=yingxiao_hbconfig&a=inviteReg').then(function (response) {
        ...
        save() {
            ...
            list.forEach(item => {
                if (item.checked) {
                    params.sy_invite_reg_hb += params.sy_invite_reg_hb ? ',' + item.id : item.id;
                }
            })
