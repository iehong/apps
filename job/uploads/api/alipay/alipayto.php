...
if($sign_type == 'MD5'){
	...
	require_once dirname(dirname(dirname(__FILE__))).'/api/aop/AopCertification.php';
	require_once dirname(dirname(dirname(__FILE__))).'/api/aop/request/AlipayTradePagePayRequest.php';
	//1、execute 使用
	$aop = new AopClient ();
