...
{
    /**
     * @var string 本地https访问
     */
    public static $LOCAL_HTTPS = "https://";
    /**
     * @var string 本地http访问
     */
    public static $LOCAL_HTTP = "http://";
     ...
     * @param string $local_protocol  请求协议
     */
    public function __construct($protocol = null, $endpoint = null, $reqMethod = null,  $reqTimeout = null, $localProtocol = null)
    {
        ...
        $this->localProtocol = $localProtocol ? $localProtocol : HttpProfile::$LOCAL_HTTPS;
    ...
    /**
     * 设置请求协议
     * @param string $localProtocol 请求协议（https://  http://）
     */
    public function setLocalProtocol($protocol) {
