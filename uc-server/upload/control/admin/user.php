...
const UC_LOGIN_SUCCEED = 0;
const UC_LOGIN_ERROR_FOUNDER_PW = -1;
const UC_LOGIN_ERROR_ADMIN_PW = -2;
const UC_LOGIN_ERROR_ADMIN_NOT_EXISTS = -3;
const UC_LOGIN_ERROR_SECCODE = -4;
const UC_LOGIN_ERROR_FAILEDLOGIN = -5;
...
class control extends adminbase {
	...
	private function _format_userlist(&$userlist) {
