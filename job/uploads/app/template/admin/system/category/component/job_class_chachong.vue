      ...
      <el-table :data="tableData" stripe border style="width: 100%;" height="100%"
        ...
        <el-table-column label="英文/拼音(点击修改)" property="e_name">
          <template slot-scope="scope">
            ...
            <span v-else>
              {{ scope.row.e_name }}<img @click="editData(scope)" class="editIcon" src="../../../admin/images/bine.png" alt="" style="margin-left: 4px;" width="14" height="14">
            </span>
          </template>
        </el-table-column>
      </el-table>
...
module.exports = {
  ...
  mounted() {
    console.log('job_class_chachong mounted', this.page)
    this.getList();
  },
  methods: {
    editData(scope) {
