...
module.exports = {
    ...
    methods: {
        ...
        getList() {
            ...
            _this.loading = true;
            httpPost('m=user&c=users_userlog&a=down', params,{hideloading: true}).then(function (response) {
        ...
        delete(params) {
            let _this = this;
            httpPost('m=user&c=users_userlog&a=deldown', params).then(function (response) {
                let res = response.data;
                if (res.error === 0) {
