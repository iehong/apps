<template>
    ...
    <div class="moduleElHight">
        ...
        <!--修改弹出框-->
        <div class="modluDrawer">
            <el-dialog title="企业环境修改" :visible.sync="editVisible" :with-header="true" :modal-append-to-body="false"
                :show-close="true" width="450px">
                <div>
                    <div class="wxsettip_small">企业全程</div>
                    <el-input placeholder="" v-model="ruleForm.name" :disabled="true"></el-input>
                    <div class="wxsettip_small ">环境标题</div>
                    ...
                    <div class="wxsettip_small">上传图片</div>
