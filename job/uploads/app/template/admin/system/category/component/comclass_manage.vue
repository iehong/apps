<template>
    <div class="moduleElenAlCategorySub">
        ...
        <el-dialog title="企业会员分类" width="40%" :visible.sync="addVisible" :modal-append-to-body="false" :append-to-body="true">
            <comclass_add :position="position" @child-event-getlist="handleList"></comclass_add>
        </el-dialog>
    </div>
</template>
