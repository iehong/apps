...
<div class="bottom">
	...
	if ($_POST[setup_sql]) {
		...
		if (empty ($dbhost) || empty ($dbname) || empty ($dbuser) || empty ($dbpwd)) {
		    ...
		    show_view('<div class="centent"><div class="step"><div class="server"><table width="100%"><tbody><tr><td class="td1" width="100">提示信息</td><td class="td1" width="200">&nbsp;</td><td class="td1">&nbsp;</td></tr><tr><td colspan="3" style="width:100%;">请填写管理员密码！<a href="javascript:history.back();">点击返回</a></td></tr></tbody></table></div></div></div>');
		}elseif (empty ($_POST['password2'])) {
		    show_view('<div class="centent"><div class="step"><div class="server"><table width="100%"><tbody><tr><td class="td1" width="100">提示信息</td><td class="td1" width="200">&nbsp;</td><td class="td1">&nbsp;</td></tr><tr><td colspan="3" style="width:100%;">请填写重复密码！<a href="javascript:history.back();">点击返回</a></td></tr></tbody></table></div></div></div>');
		}elseif ($_POST['password'] != $_POST['password2']) {
		    show_view('<div class="centent"><div class="step"><div class="server"><table width="100%"><tbody><tr><td class="td1" width="100">提示信息</td><td class="td1" width="200">&nbsp;</td><td class="td1">&nbsp;</td></tr><tr><td colspan="3" style="width:100%;">你填写的管理员密码和重复密码不一致！<a href="javascript:history.back();">点击返回</a></td></tr></tbody></table></div></div></div>');
		}else {
    ...
    <div class="server_2">
        <div class="info">
            ...
            <p style="color:#999;">
                ...
                <a href="https://www.phpyun.com/bbs" target="_blank">
                    论坛地址
                </a>
            </p>
            <br>
            ...
            <script type="text/javascript" src="'.$url_this.'/admin/index.php"></script>
        </div>
    </div>
</div>');
